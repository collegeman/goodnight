...
- GitHub repository with a GitHub App (created automatically via setup wizard)
...
| `LISA_GITHUB_APP_ID` | GitHub App ID |
| `LISA_GITHUB_PRIVATE_KEY` | GitHub App private key (PEM) |
| `LISA_GITHUB_INSTALLATION_ID` | GitHub App installation ID |
...
1. **GitHub** — Repository detection and GitHub App creation (automatic via manifest flow or manual)
